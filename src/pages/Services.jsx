...
// import bg from "../assets/images/pics/hol7.jpg"; 
import one from "../assets/images/pics/one1.png";
import two from "../assets/images/pics/two.png";
import mic from "../assets/images/pics/mic.png";
import ba from "../assets/images/pics/ba.png";
import three from "../assets/images/pics/3.jpeg";
import four from "../assets/images/pics/4.jpeg";
...
const Services = () => {
  ...
  return (
    <div
      ...
      // }}
    >
      <h2 className="font-qwitcher text-8xl text-pink-300 text-left px-6 md:px-12">
        Expert
      </h2>
      ...
      <div className="mt-10 md:px-10 sm:px-1 ml-10">
        <Slider {...settings}>
          <div>
...
const ServiceCard = ({ title, link,img }) => {
  return (
    <div
      className="relative flex w-80 flex-col bg-white bg-clip-border text-gray-700 mt-10 mb-10 shadow-[0_3px_10px_rgb(0,0,0,0.2)] ml-2 rounded-lg"
