import bg from '../assets/images/pics/pic4.png'; // Make sure the path to your image is correct
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 w-3/4">
          {servicesData.map((service, index) => (
            ...
            >
              ...
              <button className="mt-auto bg-white text-black py-2 px-4 rounded hover:bg-blue-600 transition-all duration-400">
                Learn More
              </button>
            </div>
          ))}
